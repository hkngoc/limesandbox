...
var parsers = {
  // JS - Babel
  get babel() {
    importScriptOnce("/sandpack/static/js/prettier/1.16.4/parser-babylon.js");
  ...
  // JS - Flow
  get flow() {
    importScriptOnce("/sandpack/static/js/prettier/1.16.4/parser-flow.js");
    return prettierPlugins.flow.parsers.flow;
  },
  // JS - TypeScript
  get typescript() {
    importScriptOnce("/sandpack/static/js/prettier/1.16.4/parser-typescript.js");
    return prettierPlugins.typescript.parsers.typescript;
  },
  // JS - Angular Action
  get __ng_action() {
    importScriptOnce("/sandpack/static/js/prettier/1.16.4/parser-angular.js");
  ...
  // CSS
  get css() {
    importScriptOnce("/sandpack/static/js/prettier/1.16.4/parser-postcss.js");
  ...
  // GraphQL
  get graphql() {
    importScriptOnce("/sandpack/static/js/prettier/1.16.4/parser-graphql.js");
    return prettierPlugins.graphql.parsers.graphql;
  },

  // Markdown
  get markdown() {
    importScriptOnce("/sandpack/static/js/prettier/1.16.4/parser-markdown.js");
  ...
  // YAML
  get yaml() {
    importScriptOnce("/sandpack/static/js/prettier/1.16.4/parser-yaml.js");
    return prettierPlugins.yaml.parsers.yaml;
  },

  // Handlebars
  get glimmer() {
    importScriptOnce("/sandpack/static/js/prettier/1.16.4/parser-glimmer.js");
    return prettierPlugins.glimmer.parsers.glimmer;
  },

  // HTML
  get html() {
    importScriptOnce("/sandpack/static/js/prettier/1.16.4/parser-html.js");
...
importScripts("/sandpack/static/js/prettier/1.16.4/standalone.js");
