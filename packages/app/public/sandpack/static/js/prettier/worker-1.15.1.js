...
var parsers = {
  // JS - Babylon
  get babylon() {
    importScriptOnce("/sandpack/staic/js/prettier/1.15.1/parser-babylon.js");
  ...
  // JS - Flow
  get flow() {
    importScriptOnce("/sandpack/staic/js/prettier/1.15.1/parser-flow.js");
    return prettierPlugins.flow.parsers.flow;
  },
  // JS - TypeScript
  get typescript() {
    importScriptOnce("/sandpack/staic/js/prettier/1.15.1/parser-typescript.js");
    return prettierPlugins.typescript.parsers.typescript;
  },
  // JS - Angular Action
  get __ng_action() {
    importScriptOnce("/sandpack/staic/js/prettier/1.15.1/parser-angular.js");
  ...
  // CSS
  get css() {
    importScriptOnce("/sandpack/staic/js/prettier/1.15.1/parser-postcss.js");
  ...
  // GraphQL
  get graphql() {
    importScriptOnce("/sandpack/staic/js/prettier/1.15.1/parser-graphql.js");
    return prettierPlugins.graphql.parsers.graphql;
  },

  // Markdown
  get markdown() {
    importScriptOnce("/sandpack/staic/js/prettier/1.15.1/parser-markdown.js");
  ...
  // YAML
  get yaml() {
    importScriptOnce("/sandpack/staic/js/prettier/1.15.1/parser-yaml.js");
    return prettierPlugins.yaml.parsers.yaml;
  },

  // Handlebars
  get glimmer() {
    importScriptOnce("/sandpack/staic/js/prettier/1.15.1/parser-glimmer.js");
    return prettierPlugins.glimmer.parsers.glimmer;
  },

  // HTML
  get html() {
    importScriptOnce("/sandpack/staic/js/prettier/1.15.1/parser-html.js");
...
importScripts("/sandpack/staic/js/prettier/1.15.1/standalone.js");
