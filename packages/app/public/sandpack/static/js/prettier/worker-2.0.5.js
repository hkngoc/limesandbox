...
var parsers = {
  // JS - Babel
  get babel() {
    importScriptOnce("/sandpack/static/js/prettier/2.0.5/parser-babel.js");
  ...
  // JS - Flow
  get flow() {
    importScriptOnce("/sandpack/static/js/prettier/2.0.5/parser-flow.js");
    return prettierPlugins.flow.parsers.flow;
  },
  // JS - TypeScript
  get typescript() {
    importScriptOnce("/sandpack/static/js/prettier/2.0.5/parser-typescript.js");
    return prettierPlugins.typescript.parsers.typescript;
  },
  // JS - Angular Action
  get __ng_action() {
    importScriptOnce("/sandpack/static/js/prettier/2.0.5/parser-angular.js");
  ...
  // CSS
  get css() {
    importScriptOnce("/sandpack/static/js/prettier/2.0.5/parser-postcss.js");
  ...
  // GraphQL
  get graphql() {
    importScriptOnce("/sandpack/static/js/prettier/2.0.5/parser-graphql.js");
    return prettierPlugins.graphql.parsers.graphql;
  },

  // Markdown
  get markdown() {
    importScriptOnce("/sandpack/static/js/prettier/2.0.5/parser-markdown.js");
  ...
  // YAML
  get yaml() {
    importScriptOnce("/sandpack/static/js/prettier/2.0.5/parser-yaml.js");
    return prettierPlugins.yaml.parsers.yaml;
  },

  // Handlebars
  get glimmer() {
    importScriptOnce("/sandpack/static/js/prettier/2.0.5/parser-glimmer.js");
    return prettierPlugins.glimmer.parsers.glimmer;
  },

  // HTML
  get html() {
    importScriptOnce("/sandpack/static/js/prettier/2.0.5/parser-html.js");
...
importScripts("/sandpack/static/js/prettier/2.0.5/standalone.js");
